...
>
> `https://github.com/semantic-craft/paper-muse-releases/releases/download/runtime-main-python-3.12-v1/papermuse-main-runtime-macos-arm64.tar.gz`
>
> sha256：`1c9afd28b26a1b523c47ad88724e482e4332c881910f5acf791fa4cc80a43e79`
>
> App 启动后会把用户配置、runtime、结果、缓存和日志放在 `~/Library/Application Support/PaperMuse/`。首次使用需要按 `config/secrets.toml.example` 填自己的 provider key。正式可分发 zip 发布在 [paper-muse-releases](https://github.com/semantic-craft/paper-muse-releases/releases)，构建与验收说明见 `docs/release/RELEASE_NOTES.md`。
>
> ## 怎么用
>
